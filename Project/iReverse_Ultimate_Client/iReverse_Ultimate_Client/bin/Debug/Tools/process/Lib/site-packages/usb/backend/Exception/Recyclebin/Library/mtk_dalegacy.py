...
from Recyclebin.Library.utils import LogBase, logsetup, structhelper
from Recyclebin.Library.error import ErrorHandler
from Recyclebin.Library.daconfig import DaStorage, EMMC_PartitionType
...
class DALegacy(metaclass=LogBase):
    ...
    def upload(self):
        ...
        self.info(f"Uploading legacy da: {os.path.basename(loader)}")
